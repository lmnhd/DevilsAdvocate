...
**Brand Name:** Devil's Advocate

This skill defines the core constraints for visual design and technical implementation for the Devil's Advocate brand. You must adhere to these guidelines strictly to maintain consistency.

## Brand Concept

**Devil's Advocate** is a bold, provocative debate platform that exposes cognitive friction rather than smoothing it over. The visual identity reflects this philosophy: sharp contrasts, opposing forces, and unapologetic tension.
...
1. **Dual Perspective** - Always show both sides simultaneously
2. **Cognitive Friction** - Don't hide the conflict, expose it
3. **Visual Tension** - Use contrasting colors, opposing layouts, sharp edges
4. **Provocative Clarity** - Be direct, be bold, be controversial
